...
class EndpointHandler():
    def __init__(self, path=''):
        ...
        self.birefnet.eval()
        if half_precision and torch.cuda.is_available():  # Only use half-precision on GPU
         self.birefnet.half()
    ...
    def __call__(self, data: Dict[str, Any]):
        ...
        elif isinstance(image_src, Image.Image):  # If already a PIL image, use it directly
            image_ori = image_src
        else:
